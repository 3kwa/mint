...
class LexerTestCase(unittest.TestCase):
    ...
    def whenTokenizedEqual(self, string, list_):
        self.assertEqual(list(mint.tokenizer(StringIO(string))),
                         list_)

    def test_tokens(self):
        'Empty string'
        self.whenTokenizedEqual('',
                                [
    ...
    def test_tokens3(self):
        'Special tokens'
        self.whenTokenizedEqual('#base: #if #elif #else:#def #for #',
                                [
    ...
    def test_tokens5(self):
        'Special tokens (js)'
        self.whenTokenizedEqual('#function #else if ',
                                [
    ...
    def test_tokens6(self):
        ...
        self.whenTokenizedEqual('@something= python_expression',
                                [
